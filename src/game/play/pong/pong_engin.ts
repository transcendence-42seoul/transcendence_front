...
// export const Ball = {
//   new: function (canvas?: HTMLCanvasElement, incrementedSpeed?: number) {
//     const width: number = canvas ? canvas.width : CANVAS_WIDTH;
//     const height: number = canvas ? canvas.height : CANVAS_HEIGHT;
//     return {
//       width: 18,
//       height: 18,
//       x: width / 2 - 9,
...
// export const Ai = {
//   new: (side: Side, canvas?: HTMLCanvasElement) => {
//     const width: number = canvas ? canvas.width : CANVAS_WIDTH;
//     const height: number = canvas ? canvas.height : CANVAS_HEIGHT;
//     return {
//       width: 18,
//       height: 180,
//       x: side === 'left' ? 150 : width - 150,
//       y: height / 2 - 35,
//       score: 0,
//       move: DIRECTION.IDLE,
//       speed: 8,
